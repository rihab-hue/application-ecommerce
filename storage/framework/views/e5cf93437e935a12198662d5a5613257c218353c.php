                    ...
                    <div class="tab-pane active" id="activity">
                        <div class="">
                            <div class="form-group <?php echo e($errors->has('titre') ? 'has-error' : ''); ?>">
                                <label for="titre"><?php echo e(trans('global.article.fields.titre')); ?><span class="text-danger">*</label>
                            ...
                            <div class="form-group <?php echo e($errors->has('prix') ? 'has-error' : ''); ?>">
                                <label for="prix"><?php echo e(trans('global.article.fields.prix')); ?><span class="text-danger">*</label>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" name="statut">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-AdminLTE3\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>