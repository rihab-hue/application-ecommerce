...
<?php $__env->startSection('css'); ?>
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/img/img2/contact-icon.jpg')); ?>">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?php echo e(asset('assets/img/img2/contact-icon.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-AdminLTE3\resources\views/front/contact.blade.php ENDPATH**/ ?>