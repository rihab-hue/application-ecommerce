...
@section('css')
       <!--css-->
       <link rel="shortcut icon" type="image/x-icon" href="{{asset('/assets/img/logo/logo1.png')}}">
...
@section('content')
                                                ...
                                                @auth
                                                    @if(auth()->user()->hasRole('Admin'))
                                                        <li class="nav-item mx-1">
                                                            <a class="nav-link  font-weight-bold  text-dark" href="{{route('admin.home')}}"> Espace admin</a>
                                                        </li>
                                                    @endif
                                                    <li class="nav-item mx-1">
    ...
    <main>
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay="0.5s">
                                        <a href="{{ route('login') }}" class="btn hero-btn ">Connexion</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class=" text-center zoom my-2 col-12">
            <a href="{{route('index')}}"> <img class="img-responsive" src="{{asset('/assets/img/img2/55.png')}}" width="1090" height="150"></a>
        </div>
        <br>
        ...
        <div class="categories-area section-padding30">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 ">
                    <div class="support-location-img opacity1 ml-10">
                        <img src="{{asset('/assets/img/img2/services3.png')}}" class="rounded-circle" alt="img">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
            ...
            <div class="services-area section-padding3">
                <div class="container">
                    ...
                    <div class="row " id="b">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="single-cat text-center mb-50 ">
                                <div class="cat-icon py-2 ">
                                    <img src="{{asset('/assets/img/img2/offseta.jpg')}}" alt="offset" height="90px" width="90px">
                                </div>
                                <div class="cat-cap">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="single-cat text-center mb-50">
                                <div class="cat-icon py-2">
                                    <img src="{{asset('/assets/img/img2/graphique.png')}}" alt="graphique" height="90px" width="90px">
                                </div>
                                <div class="cat-cap">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="single-cat text-center mb-50">
                                <div class="cat-icon py-2">
                                    <img src="{{asset('/assets/img/img2/sous traitance .png')}}" alt="offset" height="90px" width="90px">
                                </div>
                                <div class="cat-cap">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-catt text-center mb-50">
                            <div class="rotate">
                                <img src="{{asset('/assets/img/img2/wedding-card.png')}}" alt=" carte" height="90px" width="90px">
                            </div>
                            <br>
                            <div>
                                <h5 class="text-info">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-catt text-center mb-50">
                            <div class="rotate">
                                <img src="{{asset('assets/img/img2/flyer.png')}}" alt="flyer" height="90px" width="90px">
                            </div>
                            <br>
                            <div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-catt text-center mb-50">
                            <div class="rotate">
                                <img src="{{asset('assets/img/img2/calendar (1).png')}}" alt="calendrier" height="90px" width="90px">
                            </div>
                            <br>
                            <div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-catt text-center mb-50">
                            <div class="rotate">
                                <img src="{{asset('/assets/img/img2/carnet.png')}}" alt="carnet" height="90px" width="90px">
                            </div>
                            <br>
                            <div>
                                <h5 class="text-info">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-catt text-center mb-50">
                            <div class="rotate">
                                <img src="{{asset('/assets/img/img2/file.png')}}" alt="papier" height="90px" width="90px" ">
                        </div>
                        <br>
                        <div >
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('/assets/img/img2/bb.png')}} " alt="livre " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('/assets/img/img2/invtation.png')}} " alt="Invitation " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
                            <h5  class="text-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('/assets/img/img2/Orandonnance.png')}} " alt="Ordonnance " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
            ...
            <div class="row ">
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('/assets/img/img2/open-book.png')}} " alt="Paquet " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('/assets/img/img2/ettiquet.png')}} " alt="Etiquette " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
                            <h5  class="text-info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('assets/img/img2/port doc.png')}} " alt="Porte " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    <div class="single-catt text-center mb-50 ">
                        <div class="rotate ">
                            <img src="{{asset('assets/img/img2/notepad.png')}}" alt="bloc note " height="90px " width="90px ">
                        </div>
                        <br>
                        <div >
        ...
        <!--img-->
        <div class="testimonial-area testimonial-padding " data-background="{{asset('assets/img/gallery/FOND4.jpg')}} ">
            <div class="container ">
                ...
                <div class="row ">            
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-center ">
                        <div class="single-team mb-30 ">
                                <div class="team-img ">
                                    <img src="{{asset('assets/img/img2/innovation.png')}} " alt=" ">
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-center ">
                            <div class="single-team mb-30 ">
                                <div class="team-img ">
                                    <img src="{{asset('assets/img/img2/reliability.png ')}}" alt=" ">
                                </div>
                                <div class="team-caption ">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 text-center ">
                            <div class="single-team mb-30 ">
                                <div class="team-img ">
                                    <img src="{{asset('assets/img/img2/secure-shield.png')}} " alt=" ">
                                </div>
                                <div class="team-caption ">
