                    ...
                    <div class="tab-pane active" id="activity">
                        <div class="">
                            <div class="form-group {{ $errors->has('titre') ? 'has-error' : '' }}">
                                <label for="titre">{{ trans('global.article.fields.titre') }}<span class="text-danger">*</label>
                            ...
                            <div class="form-group {{ $errors->has('prix') ? 'has-error' : '' }}">
                                <label for="prix">{{ trans('global.article.fields.prix') }}<span class="text-danger">*</label>
