    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.articles.create") }}">
                {{ trans('global.add') }} {{ trans('global.article.title_singular') }}
            </a>
        </div>
    </div>
@endcan
            ...
            <table class=" table table-bordered table-striped table-hover datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('global.article.fields.statut') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($articles as $key => $article)
                        <tr data-entry-id="{{ $article->id }}">
                            ...
                            <td>
                                {!! ($article->statut == 1) ? '<span class="text-success">Active</span>' : '<span class="text-danger">Desactive</span>' !!}
                            </td>
                             {{--format de l'affichage index --}}
                            <td>
